...
# TODO-BEGIN: append the predictions to the monitored inference table
...
(predictions.write.mode("append").option("mergeSchema", "true").saveAsTable(predictions_table))
print(f"Appended {predictions.count():,} rows to {predictions_table}")
# TODO-END
